            ...
            <Stack gap={4} sx={{ mt: 2 }}>
              ...
              >
                ...
                <FormControl required>
                  ...
                  <FormHelperText id="my-helper-text">Use at least one letter, one numeral, and seven characters.</FormHelperText>
                </FormControl>
                <FormControl required>
                ...
                <Stack gap={4} sx={{ mt: 2 }}>
                  ...
                  >
                    <Checkbox size="sm" label="I want to receive inspiration, marketing promotions and updates via email." name="persistent" />               
                  </Box>
